    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Paste this in the <code className="font-mono text-foreground/80">&lt;head&gt;</code> of your website.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="relative overflow-hidden rounded-lg border border-border bg-surface/60">
            <pre className="overflow-x-auto px-4 py-3.5 font-mono text-xs leading-relaxed text-foreground/90">
              <code>{snippet}</code>
            </pre>
            <Button
              size="sm"
      ...
      <Card className="border-destructive/30">
        ...
        <CardContent>
          <Button variant="outline" onClick={destroy} disabled={busy} className="border-destructive/40 text-destructive hover:bg-destructive/10 hover:text-destructive">
